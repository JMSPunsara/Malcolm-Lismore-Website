...
$sql = "SELECT filename FROM landscapeimages ORDER BY upload_time DESC";
...
<head>
    ...
    <title>View Uploaded Landscape Photography Images</title>
    <style>
        body {
...
<h2>Landscape Photography Images</h2>
