...
<div class="upload-container">
    <form action="coastalupload.php" method="post" enctype="multipart/form-data">
        <label for="imageToUpload">Select image to upload:</label><br>
        <input type="file" name="imageToUpload" id="imageToUpload"><br>
        <input type="submit" value="Upload Image" name="submit">
        <button type="button" onclick="window.location.href='coastalview.php';">View Images</button>
        <button type="button" onclick="window.location.href='coastaldelete1.php';">Delete Images</button>
    </form>
</div>
