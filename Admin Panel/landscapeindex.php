...
<div class="upload-container">
    <form action="landscapeupload.php" method="post" enctype="multipart/form-data">
        <label for="imageToUpload">Select image to upload:</label><br>
        <input type="file" name="imageToUpload" id="imageToUpload"><br>
        <input type="submit" value="Upload Image" name="submit">
        <button type="button" onclick="window.location.href='landscapeview.php';">View Images</button>
        <button type="button" onclick="window.location.href='landscapedelete1.php';">Delete Images</button>
    </form>
</div>
...
<div class="gallery">
    ...
    $sql = "SELECT id, filename FROM landscapeimages";
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            ...
            echo '<form action="landscapedelete.php" method="post">';
